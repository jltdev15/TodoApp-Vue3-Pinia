<script setup>
import TaskForm from "../components/School/TaskForm.vue";
import TaskItem from "../components/School/TaskItem.vue";
import TaskUpdate from "../components/School/TaskUpdate.vue";
...
onMounted(async () => {
  const listData = JSON.parse(localStorage.getItem("SchoolTaskList"));
  if (listData === null) {
