<script setup>
import TaskForm from "../components/Work/TaskForm.vue";
import TaskItem from "../components/Work/TaskItem.vue";
import TaskUpdate from "../components/Work/TaskUpdate.vue";
import About from "../components/About.vue";
import { useTaskStore } from "../store/WorkTodoList";
...
onMounted(async () => {
  const listData = JSON.parse(localStorage.getItem("WorkTaskList"));
  if (listData === null) {
